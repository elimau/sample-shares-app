...
import {TICKER_API_CALL_DEBOUNCED_PERIOD, tickerHistoricalDataGetUrl} from './constants'
...
export function useFetchTickerHistory(ticker = "GOOG") {
  const query = tickerHistoricalDataGetUrl(ticker);
  return useFetch(query, {}, TICKER_API_CALL_DEBOUNCED_PERIOD);
}
